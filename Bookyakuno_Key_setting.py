...
kmi = km.keymap_items.new('object.translatedui_toggle', 'SEMI_COLON', 'PRESS', shift=True, oskey=True)
...
kmi_props_setattr(kmi.properties, 'name', 'modifier.add')
kmi.active = False
...
kmi = km.keymap_items.new('wm.call_menu_pie', 'DEL', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'wait_for_input', False)
kmi = km.keymap_items.new('gpencil.draw', 'RIGHTMOUSE', 'PRESS', key_modifier='R')
kmi_props_setattr(kmi.properties, 'mode', 'ERASER')
kmi_props_setattr(kmi.properties, 'wait_for_input', False)
kmi = km.keymap_items.new('gpencil.surfsk_add_surface', 'R', 'DOUBLE_CLICK')
kmi_props_setattr(kmi.properties, 'cyclic_follow', False)
...
kmi = km.keymap_items.new('curve.vertex_add', 'ACTIONMOUSE', 'CLICK', shift=True, ctrl=True)
...
kmi = km.keymap_items.new('wm.call_menu_pie', 'BACK_SPACE', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('view3d.cursor3d', 'SEVEN', 'CLICK')
...
kmi = km.keymap_items.new('view3d.snap_cursor_to_selected', 'SEVEN', 'DOUBLE_CLICK')
...
kmi = km.keymap_items.new('uv.cursor_set', 'SEVEN', 'PRESS')
...
kmi = km.keymap_items.new('file.refresh', 'R', 'PRESS', oskey=True)
...
kmi = km.keymap_items.new('file.previous', 'Z', 'PRESS')
kmi = km.keymap_items.new('file.next', 'X', 'PRESS')
