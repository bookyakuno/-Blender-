...
kmi = km.keymap_items.new('object.xxx', 'SIX', 'PRESS', alt=True, oskey=True)
...
kmi = km.keymap_items.new('wm.search_menu', 'V', 'PRESS', alt=True)
...
kmi_props_setattr(kmi.properties, 'delta', -1)
kmi = km.keymap_items.new('screen.screen_full_area', 'A', 'PRESS', ctrl=True, oskey=True)
kmi.active = False
kmi = km.keymap_items.new('screen.screen_full_area', 'A', 'PRESS', ctrl=True, oskey=True)
kmi.active = False
...
kmi_props_setattr(kmi.properties, 'end', False)
kmi = km.keymap_items.new('screen.keyframe_jump', 'PAGE_UP', 'PRESS')
kmi_props_setattr(kmi.properties, 'next', True)
kmi = km.keymap_items.new('screen.keyframe_jump', 'PAGE_DOWN', 'PRESS')
...
kmi = km.keymap_items.new('wm.call_menu_pie', 'MIDDLEMOUSE', 'PRESS', ctrl=True, alt=True)
...
kmi.active = False
kmi = km.keymap_items.new('wm.call_menu_pie', 'Q', 'PRESS')
kmi_props_setattr(kmi.properties, 'name', 'mesh.quickpie_secondary')
kmi.active = False
kmi = km.keymap_items.new('wm.call_menu_pie', 'SPACE', 'PRESS', alt=True)
...
kmi_props_setattr(kmi.properties, 'wait_for_input', False)
kmi = km.keymap_items.new('gpencil.draw', 'ACTIONMOUSE', 'PRESS', ctrl=True, key_modifier='R')
...
kmi = km.keymap_items.new('gpencil.delete', 'BACK_SPACE', 'PRESS')
kmi = km.keymap_items.new('gpencil.delete', 'DEL', 'PRESS')
...
kmi = km.keymap_items.new('s.insert', 'R', 'PRESS', shift=True)
kmi = km.keymap_items.new('r.insert', 'E', 'PRESS', shift=True)
kmi = km.keymap_items.new('g.insert', 'W', 'PRESS', shift=True)
...
kmi_props_setattr(kmi.properties, 'unselected', True)
kmi = km.keymap_items.new('pose.reveal', 'H', 'DOUBLE_CLICK')
...
kmi = km.keymap_items.new('multi.bone_reset', 'R', 'PRESS', shift=True, ctrl=True)
...
kmi = km.keymap_items.new('object.hide_view_clear', 'H', 'DOUBLE_CLICK')
...
kmi.active = False
kmi = km.keymap_items.new('wm.context_toggle', 'FOUR', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('curve.select_linked', 'R', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('wm.radial_control', 'LEFT_SHIFT', 'RELEASE', shift=True, key_modifier='X')
...
kmi_props_setattr(kmi.properties, 'image_id', 'tool_settings.image_paint.brush')
kmi_props_setattr(kmi.properties, 'secondary_tex', False)
kmi = km.keymap_items.new('wm.radial_control', 'X', 'RELEASE', shift=True)
kmi_props_setattr(kmi.properties, 'data_path_primary', 'tool_settings.image_paint.brush.strength')
kmi_props_setattr(kmi.properties, 'data_path_secondary', 'tool_settings.unified_paint_settings.strength')
kmi_props_setattr(kmi.properties, 'use_secondary', 'tool_settings.unified_paint_settings.use_unified_strength')
kmi_props_setattr(kmi.properties, 'rotation_path', 'tool_settings.image_paint.brush.mask_texture_slot.angle')
...
kmi_props_setattr(kmi.properties, 'name', 'menu.zb_brush_menu')
kmi = km.keymap_items.new('paint.image_paint', 'LEFTMOUSE', 'PRESS', shift=True)
kmi = km.keymap_items.new('paint.zb_eraser_up', 'X', 'PRESS', shift=True)
kmi = km.keymap_items.new('paint.zb_eraser_up', 'LEFT_SHIFT', 'RELEASE', shift=True)
kmi = km.keymap_items.new('paint.zb_eraser', 'LEFT_SHIFT', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'image_id', 'tool_settings.sculpt.brush')
kmi_props_setattr(kmi.properties, 'secondary_tex', False)
kmi = km.keymap_items.new('wm.radial_control', 'A', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'data_path_primary', 'tool_settings.sculpt.brush.strength')
kmi_props_setattr(kmi.properties, 'data_path_secondary', 'tool_settings.unified_paint_settings.strength')
kmi_props_setattr(kmi.properties, 'use_secondary', 'tool_settings.unified_paint_settings.use_unified_strength')
kmi_props_setattr(kmi.properties, 'rotation_path', 'tool_settings.sculpt.brush.texture_slot.angle')
...
kmi = km.keymap_items.new('paint.brush_select', 'V', 'PRESS')
kmi_props_setattr(kmi.properties, 'sculpt_tool', 'SNAKE_HOOK')
...
kmi.active = False
kmi = km.keymap_items.new('wm.call_menu_pie', 'B', 'PRESS', oskey=True)
...
kmi_props_setattr(kmi.properties, 'type', 'FACE')
kmi.active = False
kmi = km.keymap_items.new('view3d.select_border', 'EVT_TWEAK_M', 'ANY', alt=True)
...
kmi.active = False
kmi = km.keymap_items.new('view3d.select_border', 'EVT_TWEAK_L', 'ANY', shift=True)
kmi = km.keymap_items.new('view3d.select_border', 'EVT_TWEAK_L', 'ANY', shift=True, oskey=True)
...
kmi = km.keymap_items.new('mesh.select_linked', 'R', 'PRESS', oskey=True)
...
kmi_props_setattr(kmi.properties.TRANSFORM_OT_edge_slide, 'release_confirm', False)
kmi = km.keymap_items.new('mesh.subdivide', 'W', 'PRESS', shift=True, oskey=True)
...
kmi = km.keymap_items.new('view3d.zoom', 'BUTTON4MOUSE', 'PRESS')
kmi = km.keymap_items.new('mesh.looptools_gstretch', 'R', 'PRESS', ctrl=True, oskey=True)
...
kmi_props_setattr(kmi.properties, 'delimit', ['NORMAL'])
...
kmi_props_setattr(kmi.properties, 'unselected', True)
kmi = km.keymap_items.new('armature.reveal', 'H', 'DOUBLE_CLICK')
...
kmi = km.keymap_items.new('wm.context_toggle', 'B', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.use_snap')
kmi = km.keymap_items.new('armature.subdivide', 'W', 'PRESS')
kmi = km.keymap_items.new('wm.context_toggle', 'V', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.use_snap')
...
kmi = km.keymap_items.new('wm.call_menu', 'Q', 'PRESS', ctrl=True, alt=True, oskey=True)
kmi_props_setattr(kmi.properties, 'name', 'view3D.zb_layer_options_menu')
kmi.active = False
...
kmi = km.keymap_items.new('view3d.manipulator', 'LEFTMOUSE', 'PRESS', any=True)
kmi_props_setattr(kmi.properties, 'release_confirm', True)
kmi = km.keymap_items.new('view3d.cursor3d', 'SEVEN', 'DOUBLE_CLICK')
kmi = km.keymap_items.new('view3d.rotate', 'MIDDLEMOUSE', 'PRESS')
kmi.active = False
kmi = km.keymap_items.new('view3d.zoom', 'MIDDLEMOUSE', 'PRESS', oskey=True)
kmi.active = False
...
kmi = km.keymap_items.new('view3d.view_orbit', 'WHEELDOWNMOUSE', 'PRESS', alt=True, oskey=True)
...
kmi = km.keymap_items.new('view3d.camera_to_view', 'FOUR', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('view3d.object_as_camera', 'FOUR', 'PRESS', ctrl=True)
kmi.active = False
...
kmi = km.keymap_items.new('view3d.snap_cursor_to_selected', 'SEVEN', 'CLICK')
...
kmi = km.keymap_items.new('view3d.zoom_border', 'EVT_TWEAK_L', 'ANY', ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'gesture_mode', 0)
...
kmi = km.keymap_items.new('uv.uv_squares_by_shape', 'R', 'PRESS', ctrl=True, oskey=True)
...
kmi = km.keymap_items.new('uv.cursor_set', 'SEVEN', 'DOUBLE_CLICK')
...
kmi = km.keymap_items.new('uv.circle_select', 'Z', 'PRESS')
...
kmi = km.keymap_items.new('anim.change_frame', 'A', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'name', 'NODE_MT_nw_add_reroutes_menu')
kmi = km.keymap_items.new('wm.call_menu', 'R', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('node.nw_frame_selected', 'FOUR', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'mode', 'DIVIDE')
kmi_props_setattr(kmi.properties, 'merge_type', 'MIX')
kmi = km.keymap_items.new('node.nw_merge_nodes', 'FOUR', 'PRESS', ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'mode', 'SUBTRACT')
kmi_props_setattr(kmi.properties, 'merge_type', 'MIX')
kmi = km.keymap_items.new('node.nw_merge_nodes', 'NUMPAD_MINUS', 'PRESS', ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'mode', 'SUBTRACT')
kmi_props_setattr(kmi.properties, 'merge_type', 'MIX')
kmi = km.keymap_items.new('node.nw_merge_nodes', 'FOUR', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'mode', 'MULTIPLY')
kmi_props_setattr(kmi.properties, 'merge_type', 'MIX')
...
kmi = km.keymap_items.new('wm.context_toggle', 'V', 'PRESS')
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.use_snap')
kmi = km.keymap_items.new('node.nw_merge_nodes', 'R', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'mode', 'MIX')
...
kmi_props_setattr(kmi.properties, 'fill', True)
kmi_props_setattr(kmi.properties, 'open', False)
kmi = km.keymap_items.new('file.previous', 'Z', 'CLICK')
...
kmi = km.keymap_items.new_modal('BEGIN', 'LEFTMOUSE', 'PRESS', shift=True, oskey=True)
kmi = km.keymap_items.new_modal('DESELECT', 'LEFTMOUSE', 'RELEASE', shift=True, oskey=True)
kmi = km.keymap_items.new_modal('BEGIN', 'LEFTMOUSE', 'PRESS')
