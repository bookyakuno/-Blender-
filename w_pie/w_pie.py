...
# bl_info = {
#     "name": "Wazou Pie Menus bk.Edit_xxx",
...
#Pivot to Bottom エディットモードでも原点を移動
...
class PieOriginPivot(Menu):
    ...
    def draw(self, context):
        ...
        #8 - TOP 編集xx
        pie.operator("object.origin_set_cursor_x", text="Origin To 3D Cursor", icon='CURSOR') #編集
...
class PieSelectionsOM(Menu):
    ...
    def draw(self, context):
        ...
        pie.operator("object.select_grouped", text="Select Grouped", icon='ROTATE').type='GROUP'
